...
- [`docs/remote-docker-backlog.md`](./docs/remote-docker-backlog.md) — the **remote-docker** provider (docker on a machine you own, over SSH): what shipped, what was verified live, what's left. Design rationale is in `cloud-providers.md` §3e.
