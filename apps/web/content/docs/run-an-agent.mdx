...
Under the hood the skill calls `agentbox fork`, which you can also run directly on the host. It opens the box in a new terminal tab under iTerm or tmux; otherwise it runs in the background. The skill, and the other AgentBox-provided skills, are covered in [AgentBox Skills](/docs/skills).
