...
See [Local Docker](/docs/local-docker), [Hetzner](/docs/hetzner), [DigitalOcean](/docs/digitalocean), [Daytona](/docs/daytona), [Vercel](/docs/vercel), and [E2B](/docs/e2b).
...
# Update agentbox (refreshes skills, wipes the box image so it rebuilds,
